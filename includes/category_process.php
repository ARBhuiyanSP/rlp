 ...
 * Insert Project Info at assets_categories table
 */
if (isset($_POST['category_submit']) && !empty($_POST['category_submit'])) {
        ...
        */ 
        ...
        $query = "INSERT INTO `assets_categories` (`assets_id`,`assets_category`) VALUES ('$assets_id','$assets_category')";
        $conn->query($query);
        
		$_SESSION['success']    =   "Assets CAtegory Entry process have been successfully completed.";
		header("location: assets-category.php");
		exit();
}
